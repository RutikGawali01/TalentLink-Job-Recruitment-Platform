...
// trt to debug on paper
    if (filter.Skills && filter.Skills.length > 0) {
      filterTalent = filterTalent.filter((talent) =>//“Include this talent if---> any selected skill----> exists in any of the talent’s skills”
        filter.Skills?.some((skill) =>// for selected skill
    ...
    <div className="p-5 ">
      <div className="mx-34">
          <div className="flex justify-between">
            <div className="text-3xl  font-semibold text-center ">Talents</div>
            <div className="rounded-3xl">
              {/* sort for talents and jobs */}
              <Sort />
            </div>
          </div>
      </div>
